    ...
    [_assetsLibrary enumerateGroupsWithTypes:ALAssetsGroupSavedPhotos
                                  usingBlock:^(ALAssetsGroup *group, BOOL *stop) {
                                      ...
                                      if (group && group.numberOfAssets) {
                                          ...
                                          //
                                          DCAssetsContentViewController *assetsContentViewController = [[UIStoryboard storyboardWithName:@"Main" bundle:nil] instantiateViewControllerWithIdentifier:@"dcImagePickerContentView"];
